...
// 4. PROCESSAMENTO PARA O GRID (COM TODOS OS HORÁRIOS)
$calendario_grid = [];
$horarios_semana = [
    "07:10", "08:00", "08:50", "10:00", "10:50", "11:40", // Manhã
    "13:30", "14:20", "15:10", "16:20", "17:10", "18:00", // Tarde
    "18:30", "19:20", "20:10", "21:20", "22:10"          // Noite
];
...
<body>
    ...
    <main>
        ...
        <section class="area-lado-direito">
            <div class="calendario-lado-direito">
                ...
                <div class="dias-da-semana-calendario-lado-direito">
                    <p class="dia-semana seg">Seg</p><p class="dia-semana ter">Ter</p><p class="dia-semana qua">Qua</p><p class="dia-semana qui">Qui</p><p class="dia-semana sex">Sex</p><p class="dia-semana sab">Sab</p><p class="dia-semana dom">Dom</p>
                </div>
        ...
        <div id="modal-overlay" class="modal-overlay" style="display: none;">
            <div class="modal-content"><h3>Carregando...</h3></div>
        </div>
