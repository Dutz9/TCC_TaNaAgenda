    ...
    <main>
        ...
        <section class="formulario-evento" >
            ...
            <div class="linha-form">
                ...
                <div class="botoes">
                    <a href="meuseventos.html"><button type="button" class="botao-cancelar">Cancelar</button></a>
                    <a href="meuseventos.html"><button type="submit" class="botao-enviar">Enviar Solicitação</button></a>
                </div>
            </div>
        </section>
</body>
