    ...
    <main>
        ...
        <section class="formulario-turma" >
            ...
            <div class="linha-botoes">
                <div class="botoes">
                    <a href="turmas.html"><button type="button" class="botao-cancelar">Cancelar</button></a>
                    <a href="turmas.html"><button type="submit" class="botao-enviar">Adicionar Turma</button></a>
                </div>
            </div>
        </section>
</body>
