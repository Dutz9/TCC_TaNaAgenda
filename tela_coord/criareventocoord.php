...
<body>
    ...
    <main>
        ...
        <section class="formulario-evento" >
            ...
            <div class="botoes">
                    <a href="eventoscoord.html"><button type="button" class="botao-cancelar">Cancelar</button></a>
                    <a href="eventoscoord.html"><button type="submit" class="botao-enviar">Criar e Notificar</button></a>
                </div>
        </section>
</body>
</html>