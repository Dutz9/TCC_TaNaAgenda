...
<head>
    ...
    <title>Notificações - TáNaAgenda</title>
...
<body>
    ...
    <header class="header">
        <a href="perfilcoord.html"><p>Coordenador</p></a>
    ...
    <main>
        ...
        <section class="area-lado">
            <a href="agendacoord.html"><img src="../image/logotipo fundo azul.png" alt=""></a>
            <div class="area-menu">
                <div class="menu-agenda">
                    ...
                    <a href="agendacoord.html"><p>Agenda</p></a>
                </div>
                <div class="menu-meus-eventos">
                    ...
                    <a href="eventoscoord.html"><p>Meus Eventos</p></a>
                </div>
                <div class="menu-notificacoes  ativo">
...
<section class="area-notificacoes">
    ...
    <div class="notificacao-container">
        ...
        <div class="notificacao">
            <h3>Título do Evento</h3>
            <p>Solicitado por: professor</p>
            <p>Data de Solicitação: 12/08/2025</p>
        ...
        <div class="notificacao">
            <h3>Título do Evento</h3>
            <p>Solicitado por: professor</p>
            <p>Data de Solicitação: 13/08/2025</p>
            <p>Data do Evento: 02/09/2025</p>
            <button class="detalhes-btn">Mais Detalhes</button>
        </div>
        <div class="notificacao">
            <h3>Título do Evento</h3>
            <p>Solicitado por: professor</p>
            <p>Data de Solicitação: 14/08/2025</p>
            <p>Data do Evento: 03/09/2025</p>
            <button class="detalhes-btn">Mais Detalhes</button>
        </div>
        <div class="notificacao">
            <h3>Título do Evento</h3>
