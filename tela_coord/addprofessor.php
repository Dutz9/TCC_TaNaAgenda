    ...
    <main>
        ...
        <section class="formulario-professor" >
            ...
            <div class="linha-botoes">
                <div class="botoes">
                    <a href="professores.html"><button type="button" class="botao-cancelar">Cancelar</button></a>
                    <a href="professores.html"><button type="submit" class="botao-enviar">Adicionar Professor</button></a>
                </div>
            </div>
        </div>
    </section>
