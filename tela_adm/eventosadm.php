...
<head>
    ...
    <title>Eventos (ADM) - TáNaAgenda</title>
...
<body>
    ...
    <main>
        ...
        <section class="area-notificacoes">
            ...
            <form id="form-filtros" action="eventosadm.php" method="GET" class="container-filtros">
                ...
                <a href="eventosadm.php" class="botao-limpar">Limpar Filtros</a>
